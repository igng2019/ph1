...
var RecentNotes_default = /* @__PURE__ */ __name(((userOpts) => {
  const RecentNotes = /* @__PURE__ */ __name(({
    ...
    return /* @__PURE__ */ jsxs19("div", { class: classNames(displayClass, "recent-notes"), children: [
      /* @__PURE__ */ jsx32("h3", { children: opts.title ?? i18n(cfg.locale).components.recentNotes.title }),
      /* @__PURE__ */ jsx32("ul", { class: "recent-ul", children: pages.slice(0, opts.limit).map((page) => {
        const title = page.frontmatter?.title ?? i18n(cfg.locale).propertyDefaults.title;
        const tags = page.frontmatter?.tags ?? [];
        return /* @__PURE__ */ jsx32("li", { class: "recent-li", children: /* @__PURE__ */ jsxs19("div", { class: "section", children: [
          /* @__PURE__ */ jsx32("div", { class: "desc", children: /* @__PURE__ */ jsx32("h3", { children: /* @__PURE__ */ jsx32("a", { href: resolveRelative(fileData.slug, page.slug), class: "internal", children: title }) }) }),
          page.dates && /* @__PURE__ */ jsx32("p", { class: "meta", children: /* @__PURE__ */ jsx32(Date2, { date: getDate(cfg, page), locale: cfg.locale }) }),
          opts.showTags && /* @__PURE__ */ jsx32("ul", { class: "tags", children: tags.map((tag) => /* @__PURE__ */ jsx32("li", { children: /* @__PURE__ */ jsx32(
            "a",
            {
              class: "internal tag-link",
              href: resolveRelative(fileData.slug, `tags/${tag}`),
      ...
      opts.linkToMore && remaining > 0 && /* @__PURE__ */ jsx32("p", { children: /* @__PURE__ */ jsx32("a", { href: resolveRelative(fileData.slug, opts.linkToMore), children: i18n(cfg.locale).components.recentNotes.seeRemainingMore({ remaining }) }) })
    ] });
  }, "RecentNotes");
